...
import info.mschmitt.battyboost.core.ui.PosListAdapter;
import info.mschmitt.battyboost.serviceapp.Router;
import info.mschmitt.battyboost.serviceapp.databinding.PosListViewBinding;
...
public class PosListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        PosListAdapter adapter = new PosListAdapter(database.getReference("pos"), this::onPosClick);
